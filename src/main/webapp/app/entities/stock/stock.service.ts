...
export class StockService {
  ...
  findByProductCode(productCode: string, req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IStock[]>(`${this.resourceUrl}/product/${productCode}`, { params: options, observe: 'response' });
  }
